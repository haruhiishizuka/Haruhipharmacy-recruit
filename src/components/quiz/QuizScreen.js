                            ...
                            <label key={value} style={{ 
                              ...
                              <div
                                style={{
                                  ...
                                  borderRadius: '50%',
                                  backgroundColor: 
                                    answers[question.id] === value ? '#333333' : 'var(--neutral-100)',
                                  display: 'flex',
                                  alignItems: 'center',
                                  ...
                                  border: `2px solid ${
                                    answers[question.id] === value ? '#333333' : 'var(--neutral-300)'
                                  }`,
              ...
              <div className="flex_horizontal" style={{ 
                ...
                {Array.from({ length: totalPages }).map((_, index) => (
                  <div key={index} style={{
                    ...
                    height: '4px',
                    borderRadius: '2px',
                    backgroundColor: index === currentPage ? '#333333' : 'var(--neutral-300)'
                  }}></div>
                ))}
              </div>
