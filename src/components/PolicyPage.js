...
const PolicyPage = ({ onReturnHome }) => {
  ...
  return (
    <div style={{ 
          ...
          >
            ...
            <div style={{ marginBottom: '30px' }}>
              ...
              <div style={{ 
                ...
                <p style={{ marginBottom: '8px', fontSize: '16px', fontWeight: '600', color: '#1A6CBF' }}>株式会社はるひメディカルサービス</p>
                <p style={{ marginBottom: '8px', fontSize: '15px', color: '#4A5568' }}>住所：〒482-0025 愛知県岩倉市大地新町3丁目45番地2</p>
                <p style={{ marginBottom: '8px', fontSize: '15px', color: '#4A5568' }}>電話番号：0587-50-7535</p>
                <p style={{ marginBottom: '8px', fontSize: '15px', color: '#4A5568' }}>メールアドレス：info@haruhi-medical.com</p>
                <p style={{ marginBottom: '8px', fontSize: '15px', color: '#4A5568' }}>担当者：個人情報保護管理者 平島 禎之</p>
              </div>
            </div>
        ...
        {activeTab === 'terms' && (
          ...
          >
            <div style={{ marginBottom: '30px' }}>
              ...
              <p style={{ marginBottom: '12px', fontSize: '16px', color: '#4B5563' }}>
                株式会社はるひメディカルサービス（以下「当社」といいます）が提供するMediMatch（以下「本サービス」といいます）をご利用いただく際には、本利用規約に同意いただく必要があります。本サービスを利用することにより、利用者は本規約に同意したものとみなされます。
              </p>
            </div>
          ...
          >
            <div style={{ marginBottom: '30px' }}>
              ...
              <div style={{
                ...
                <p style={{ margin: '0 0 15px 0', fontSize: '16px', color: '#4A5568', lineHeight: '1.7' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <h3 style={{ fontSize: '22px', fontWeight: '600', color: '#2D3748', marginBottom: '12px' }}>
                    お電話でのお問い合わせ
                  </h3>
                  <p style={{ textAlign: 'center', marginBottom: '20px', fontSize: '16px', color: '#4A5568' }}>
                    平日 9:00〜18:00<br />
                    土日祝 要予約
                  </p>
                  <a 
              ...
              <div style={{ 
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    ...
                    <tr>
                      <th style={{ padding: '12px 10px', textAlign: 'left', width: '30%', fontSize: '15px', color: '#1A6CBF', verticalAlign: 'top' }}>有料職業紹介事業許可</th>
                      <td style={{ padding: '12px 10px', fontSize: '15px', color: '#4A5568' }}>厚生労働大臣許可 23-ユ-302928</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      {/* フッター */}
      <footer style={{ textAlign: 'center', marginTop: '40px', color: 'white', fontSize: '13px', paddingBottom: '20px', lineHeight: '1.8' }}>
